type ObjectKeyAny = { [key: string]: any };
/*! *****************************************************************************
...
export namespace Reflect {
  ...
  (function (
    this: any,
    factory: (
      exporter: <K extends keyof typeof Reflect>(key: K, value: typeof Reflect[K]) => void
    ) => void
  ) {
    const root =
    ...
    function makeExporter(
      ...
      previous?: <K extends keyof typeof Reflect>(key: K, value: typeof Reflect[K]) => void
    ) {
